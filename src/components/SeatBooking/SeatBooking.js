...
export default function SeatBooking(props) {
  ...
  const fetchData = () => {
    return fetch(
      ...
      //`https://eventbooking-3f9ae-default-rtdb.firebaseio.com/events/${props.eventId}.json`
      `https://bookevents-8f33c-default-rtdb.firebaseio.com/events/${props.eventId}.json`
    );
  };
